...
const manuals: Record<CloudProvider, { title: string, steps: string[] }> = {
  ...
  'google-drive': {
    title: t('Google Driveの設定方法'),
    steps: [
      '<strong>Google Cloud Consoleでの設定：</strong>',
      '1. <a href="https://console.cloud.google.com/" target="_blank">Google Cloud Console</a>にアクセス',
      '2. 新しいプロジェクトを作成するか、既存のプロジェクトを選択',
      '3. 左メニューから「APIとサービス」→「ライブラリ」を開く',
      '4. 「Google Drive API」を検索して有効化',
      '5. 「APIとサービス」→「認証情報」を開く',
      '6. 「認証情報を作成」→「OAuthクライアントID」を選択',
      '7. アプリケーションの種類で「ウェブアプリケーション」を選択',
      '8. 承認済みのリダイレクトURIを設定（例: http://localhost）',
      '9. <strong>クライアントID</strong>と<strong>クライアントシークレット</strong>を保存',
      '',
      '<strong>アクセストークンの取得：</strong>',
      '1. OAuth 2.0プレイグラウンド（<a href="https://developers.google.com/oauthplayground/" target="_blank">https://developers.google.com/oauthplayground/</a>）にアクセス',
      '2. 右上の歯車アイコンをクリック→「Use your own OAuth credentials」にチェック',
      '3. クライアントIDとクライアントシークレットを入力',
      '4. 左側で「Drive API v3」を選択し、以下のスコープを選択：',
      '   • https://www.googleapis.com/auth/drive.file',
      '5. 「Authorize APIs」をクリックしてGoogleアカウントで認証',
      '6. 「Exchange authorization code for tokens」をクリック',
      '7. 表示された<strong>Access token</strong>をコピー',
      '',
      '<strong>設定項目：</strong>',
      '• <strong>アクセストークン：</strong> 上記で取得したOAuth 2.0アクセストークン',
      '',
      '<strong>⚠️ 注意事項：</strong>',
      '• アクセストークンには有効期限があります（通常1時間）',
      '• 長期的に使用する場合は、リフレッシュトークンを使用してトークンを更新する仕組みが必要です',
      '• より安全な実装として、サーバーサイドでOAuth認証を行うことを推奨します',
    ],
  },
  'dropbox': {
